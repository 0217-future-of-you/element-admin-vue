<template>
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="Url" label="路径" width="120">
        </el-table-column>
        <el-table-column prop="NeedActionText" label="需要权限" width="120">
        </el-table-column>
        <el-table-column
          prop="PermissionValues"
          label="页面权限"
          show-overflow-tooltip
        >
          <template slot-scope="scope">
            {{ setJoin(scope.row.PermissionValues)  }}
          </template>
        </el-table-column>
            <el-table-column
          prop="icon"
      ...
      <!-- <el-table-column prop="Birthday" label="排序" width="120">
        </el-table-column> -->
...
<script>
import { GetDataList,deleteData } from "../../../api/menu";
...
export default {
  ...
  methods: {
    ...
    GetData() {
      let that = this;
      GetDataList(this.Entity).then(res => {
